...
echo "$HOME/colcon_ws/src/STELLA_ODROID_C4_ROS2/stella_bringup/stella.rules"
sudo cp $HOME/colcon_ws/src/STELLA_ODROID_C4_ROS2/stella_bringup/stella.rules  /etc/udev/rules.d
echo " "
